		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown">實體作品 <span class="caret"></span></a>
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown">周邊<span class="caret"></span></a>
					<ul class="dropdown-menu" role="menu">
						<li class="dropdown-header"></li>
						<li><a href="#">副選單一</a></li>
						<li><a href="#">副選單二</a></li>
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown">書籍<span class="caret"></span></a>
					<ul class="dropdown-menu" role="menu">
						<li class="dropdown-header"></li>
						<li><a href="#">副選單一</a></li>
						<li><a href="#">副選單二</a></li>
	...
	<div class="container-fluid text-center">
		<div class="row content">
		  ...
		  <p> </p> -->
				...
				<a href=" " target="_blank" title="商品1"> </a>
					<img src="../images/MuMu1.jpg" class="img-thumbnail" width="140" height="140" >
					<!-- <div class="info">
						<div class="owner">by<a href="" target="_blank">創作者</a></div>
					</div>
				</div> -->
