...
<jsp:include page="/fragment/top.jsp" />
     ...
     <TR height="60" >
         ...
         <TR>
             ...
             <TD width="200"  align="center">
                 <Font color="#006600" size='4' face="標楷體">建立專案</Font>
             </TD>
         <!-- 此區塊顯示程式執行後的訊息 -->
  ...
  <form ENCTYPE="multipart/form-data" method="POST" action="<c:url value='../_07_funds/FundCreate.do' />"  id="FundCreate.do" >
      <label class="fontSize" >專案名稱：</label>
      <input type="text" name="fcname" value="${param.fcname}" class="fieldWidth" style="width: 200px;">
      <!-- 
         注意value屬性的內容以及顯示錯誤訊息的寫法
      -->
      <font size="-1" color="#FF0000">${MsgMap.errorfcnameEmpty}${MsgMap.errorfcnameDup}</font>
      <br/>
      <label class="fontSize" >專案金額：</label>
      <input type="text" name="fcmoneys" value="${param.fcmoneys}" class="fieldWidth" style="width: 200px;">
      <font color="red" size="-1">${MsgMap.errorfcmoneysEmpty}</font>      
      <br/>
      
      <label class="fontSize" >專案開始日期：</label>
      <input type="date" name="starttime" value="${param.starttime}"   class="fieldWidth" style="width: 200px;">
      <font color="red" size="-1">${MsgMap.errorstarttimeEmpty}</font>            
      <br/>
      
      <label class="fontSize" >專案結束日期：</label>
      <input type="date" name="endtime" value="${param.endtime}"  class="fieldWidth" style="width: 200px;">
      <font color="red" size="-1">${MsgMap.errorendtimeEmpty}</font>
      <br/>
      
      <label class="fontSize" >專案簡介：</label>
      <textarea name="fcintroduction" rows="5" cols="20" class="fieldWidth"></textarea><br>
