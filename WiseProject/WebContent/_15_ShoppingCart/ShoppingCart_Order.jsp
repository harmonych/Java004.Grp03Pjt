...
<div class="wrapper">
        ...
        <header class="main-header">
          ...
          <!-- Logo -->
          <a href="${context }/index.jsp" class="logo">
							...
							<form id="form1" method="post" action="<c:url value='/_04_ShoppingCart/CreateOrder.do' />">
								<div class="box-body">
									...
									<div class="form-group">
										...
										<input type="radio" name="payment" value="轉帳"> 轉帳<br /> 
										<input type="radio" name="payment" value="匯款"> 匯款<br />
										<input type="radio" name="payment" value="信用卡"> 信用卡<br />

									</div>
									<div class="form-group2">
										<label for="">出貨方式</label><br /> 
										<input type="radio" name="transport" value="貨運"> 貨運<br /> 
										<input type="radio" name="transport" value="宅配"> 宅配<br />
										<input type="radio" name="transport" value="面交"> 面交<br />
