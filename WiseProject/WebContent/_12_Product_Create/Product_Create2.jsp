...
<title>建立商品</title>
<link rel="stylesheet" href="../css/Product_Create2.css">
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="active"><a href="_05_CreationsFrame/Creations.jsp"><i
				...
				<div class="row">
					...
					<div class="card02 col-md-4">
						<form ENCTYPE="multipart/form-data" method="POST"
							action="<c:url value='../_09_product/ProductCreate.do' />"
							id="ProductCreate.do">
							<div>
								<div id="ipt1">
