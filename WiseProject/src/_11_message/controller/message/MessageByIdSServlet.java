...
@WebServlet("/_06_mailbox/messageByMsgIdS.do")
public class MessageByIdSServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		request.getRequestDispatcher("ReadMailS.jsp").forward(request, response);	
	}
}
