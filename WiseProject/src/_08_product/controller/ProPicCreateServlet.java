...
@WebServlet("/_08_product/pic.do")
public class ProPicCreateServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		String pic_adress = "http://saudade.myasustor.com/JPjt/fc_pic_address/" + fileName;
		try {
			...
			FcPicBean fb = new FcPicBean(pro_id,pic_adress);
